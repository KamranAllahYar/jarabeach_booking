		...
		<div class="flex flex-col w-full h-full py-6 md:w-7/12">
          ...
          or shaded by Jara's exclusive Lookout, your cares being eased away by one of our expert masseuses.-->
				...
				<div class="mt-3">
					...
					<div @click="addNewMassage" v-if="showAddButton" class="flex items-center flex-shrink-0 w-auto h-10 mt-0 text-xs cursor-pointer text-brand-blue hover:text-brand-blue-300">
