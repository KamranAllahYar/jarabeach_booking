    ...
    <div class="flex flex-col w-full h-full py-6 md:w-7/12">
      <div class="flex-1 px-6 pb-4 md:overflow-y-auto" id="con_scroll">
        ...
        <p class="mt-3 font-light leading-relaxed text-gray-600">
          Jara’s in-house masseuse provides a range of relaxing treatments. Located in the Lookout on the beachfront,
          you’ll be cooled by the gentle ocean breeze, your cares being eased away.
          30 minute and one-hour treatments available from just N10,000.
