    ...
    <div class="flex flex-col w-full p-6 md:w-7/12">
      ...
      <p class="mt-3 font-light leading-relaxed text-gray-600">
        ...
        <a
          ...
          href="https://www.jarabeachresort.com/special-requests"
        >https://www.jarabeachresort.com/special-requests</a>

        <br />Commercial photoshoot enquiries are handled directly by our bookings department - more details here:
        ...
        <a
          target="_blank"
          class="text-brand-blue-500"
          href="https://www.jarabeachresort.com/photo-shoots"
        >https://www.jarabeachresort.com/photo-shoots</a>-->
      </p>
      ...
      <div class="grid items-center mt-3 font-light md:grid-cols-2 gap-y-2">
        <label class="flex items-center">
          <input type="radio" :value="bookingDate" v-model="selectedDate" class="mr-3 rounded-full focus-within:ring-0 text-brand-blue-400 border-brand-blue-400" />
      ...
      <div>
        ...
        <div class="grid w-full grid-cols-3 mt-3 gap-x-3 gap-y-3">
          <div class="flex items-center pl-2 border rounded-md focus-within:ring">
            <svg class="w-5 h-5" fill="none" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M7.5 7.96875c1.81218 0 3.2812-1.46907 3.2812-3.28125S9.31218 1.40625 7.5 1.40625c-1.81218 0-3.28125 1.46907-3.28125 3.28125S5.68782 7.96875 7.5 7.96875zM1.40625 14.5312c0-1.6161.64202-3.1661 1.78482-4.3089C4.33387 9.07952 5.88384 8.4375 7.5 8.4375c1.61616 0 3.1661.64202 4.3089 1.7848 1.1428 1.1428 1.7848 2.6928 1.7849 4.3089"
                stroke="#225A89"
                stroke-width=".8"
            ...
            <select v-model="noOfArtists" class="w-full border-0 rounded-md outline-none focus:outline-none" style="box-shadow: none">
              <option value="0">0</option>
              <option v-for="num in 4" :value="num" :key="num">{{ num }}</option>
            </select>
          </div>
        </div>
      </div>
