                        ...
                        <div class="px-3 py-4 border-b" v-for="(guest, ix) in others" :key="ix">
                            ...
                            <div class="flex items-center">
                                <div class="mr-3">
                                    ...
                                    <svg class="w-5 h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" v-else-if="guest.type == 'child'">
                                    ...
                                    <svg class="w-5 h-5" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" v-else>
