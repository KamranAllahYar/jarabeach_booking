<template>
    <div>
        ...
        <div class="flex flex-col justify-center space-y-6 md:space-x-6 md:space-y-0 md:flex-row">
                    ...
                    <div class="border rounded-md">
                        <div class="px-3 py-4 border-b" v-for="(guest, ix) in others" :key="ix">
                            ...
                            <div class="flex items-center">
                                <div class="mr-3">
                                    <svg class="w-5 h-5" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" v-if="guest.type == 'adult'">
                                    ...
                                    <svg class="w-5 h-5" viewBox="0 0 16 16" stroke="currentColor" fill="none" xmlns="http://www.w3.org/2000/svg" v-else-if="guest.type == 'infant'">
                                    ...
                                    <svg class="w-5 h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" v-else>
