<template>
    <div>
        ...
        <form @submit.prevent="findBooking()" class="flex-shrink-0 block max-w-md px-6 py-6 mx-auto mt-10 bg-white border rounded-lg shadow-lg">
        ...
        <div class="flex items-center justify-center max-w-2xl mx-auto space-x-6">
            ...
            <div class="w-1/2">
                <MainButton @click="loadOldBooking()">LOAD</MainButton>
            </div>
