            ...
            <div class="border rounded-lg">
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center pl-2 space-x-2 rounded-md focus-within:ring">
                        ...
                        <input type="text" required placeholder="34ERBUI1" class="w-full px-0 border-0 border-transparent rounded-md" style="box-shadow: none" />
                    </div>
                </div>
                <div class="p-4 border-t">
                    ...
                    <div class="flex items-center pl-2 space-x-2 rounded-md focus-within:ring">
                        ...
                        <input type="text" required placeholder="Genevieve" class="w-full px-0 border-0 border-transparent rounded-md" style="box-shadow: none" />
                    </div>
                </div>
