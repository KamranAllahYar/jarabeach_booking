<template>
    <div>
        ...
        <div class="flex justify-center mb-20 space-x-6">
            <form @submit.prevent="findBooking()" class="flex-shrink-0 block w-1/3 max-w-md px-6 py-6 mt-10 bg-white border rounded-lg shadow-lg">
            ...
            <div class="w-1/3" v-if="full_booking">
                <div class="mx-auto mt-6 mb-6 text-gray-800 border rounded-md border-brand-blue-300 bg-brand-blue-100">
                    ...
                    <div class="flex items-center justify-between px-3 my-3" v-for="(value, key) in full_booking.prices" :key="key">
        ...
        <!-- <div class="flex items-center justify-center max-w-2xl mx-auto space-x-6">
            <div class="w-1/2 mx-auto mt-6 text-gray-800 border rounded-md border-brand-blue-300 bg-brand-blue-100" v-if="full_booking">
                <div class="px-3 py-3 text-xl font-bold border-b border-brand-blue-300">Your Booking</div>
...
export default {
    ...
    methods: {
            ...
            this.$axios
                ...
                .then((res) => {
                    ...
                    if (response.success) {
                        ...
                        this.full_booking = response.data;
                    } else {
        ...
        async loadOldBooking() {
            this.$store.commit("SET_EDIT_BOOKINGS", this.full_booking);
