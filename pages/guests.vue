  ...
  <div>
    ...
    <div class="max-w-md px-6 py-4 mx-auto mt-10 bg-white border rounded-lg">
      <div class="border rounded-lg">
        <div class="p-4">
          <div class="mb-4 text-sm font-semibold">Select guest make-up</div>
          <div class="w-full">
            <div class="flex items-center space-x-4">
              ...
              >
                ...
                <div class="text-sm font-light">Adults</div>
                <select
                  name="adult"
                  id="adult"
                  v-model="noOfAdult"
              ...
              <div class="flex items-center space-x-2">
                ...
                <div class="text-sm font-light">Children</div>
                <select
                  name="adult"
                  id="children"
    ...
    <span
      @click="gotoNext()"
      class="p-3 mt-10 bg-gray-200 rounded cursor-pointer"
      >Next</span
    >
  </div>
</template>
