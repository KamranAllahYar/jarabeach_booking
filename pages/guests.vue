            ...
            <div class="w-full">
              <div class="flex items-center my-5 bg-green-100">
                <div class="flex items-center space-x-2">
                  ...
                  <div class="w-2/6 text-sm font-light">Adults</div>
                  <select name="adult" id="adult" v-model="noOfAdult" class="text-sm">
                ...
                <div class="flex items-center mt-5 space-x-2">
                  ...
                  <div class="w-2/6 text-sm font-light">Children</div>
