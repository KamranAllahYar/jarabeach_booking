<template>
	<div>
		<div class="px-6 text-lg font-semibold text-center md:px-0">
			<div>
				Step 1 (below): Tell us about your group visiting overnight /
				<a class="underline hover:text-brand-blue" href="https://www.jarabeachresort.com/room-detail" target="_blank">
					Room Detail
				</a>
			</div>
			<div>
		...
		<div class="mt-3 text-center">By proceeding you understand your payment is transferable but non-refundable in line with <a class="text-brand-blue" href="https://www.jarabeachresort.com/terms">www.jarabeachresort.com/terms</a> </div>
				...
				<div class="p-4 border-t" v-if="noOfChildren">
					...
					<div class="grid w-full md:grid-cols-3 gap-x-3 gap-y-3">
						<div class="flex items-center pl-2 rounded-md focus-within:ring" v-for="(child, i) in childrenAges" :key="i">
							<svg class="flex-shrink-0 w-5 h-5" viewBox="0 0 16 16" stroke="currentColor" fill="none" xmlns="http://www.w3.org/2000/svg" v-if="child.age == '0 - 2'">
								<path
									d="M13.75 6.583h-.01C13.5 3.55 10.706 1.55 8 1.55s-5.5 2-5.74 5.033h-.01a1.75 1.75 0 100 3.5h.01a6 6 0 0011.48 0h.01a1.75 1.75 0 100-3.5z"
									stroke="#225A89"
									stroke-width=".8"
							...
							<svg class="flex-shrink-0 w-5 h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" v-else-if="child.age == '3 - 5'">
								<path
									stroke="#225A89"
									stroke-width=".2"
									stroke-linecap="round"
							...
							<svg class="flex-shrink-0 w-5 h-5" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" v-else-if="child.age == '6 - 17'">
								<path
									stroke="#225A89"
									stroke-width=".8"
									stroke-linecap="round"
							...
							<svg class="flex-shrink-0 w-5 h-5" viewBox="0 0 16 16" stroke="currentColor" fill="none" xmlns="http://www.w3.org/2000/svg" v-else>
								<path
									d="M13.75 6.583h-.01C13.5 3.55 10.706 1.55 8 1.55s-5.5 2-5.74 5.033h-.01a1.75 1.75 0 100 3.5h.01a6 6 0 0011.48 0h.01a1.75 1.75 0 100-3.5z"
									stroke="#225A89"
									stroke-width=".8"
