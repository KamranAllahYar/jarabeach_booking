<template>
  <div>
    <h1 class="px-6 mb-6 text-xl font-bold text-center md:px-0 md:text-2xl">
      Please accept our house rules (required)
    </h1>
    ...
    >
      <div class="w-full md:w-8/12 mx-auto">
        ...
        >
          <div class="bg-white rounded-md" v-if="currentPolicy">
            ...
            <div class="px-3 py-4 bg-gray-100">
              <pre
                class="w-full overflow-y-auto h-80"
                v-html="currentPolicy.content"
              ></pre>
            </div>
            ...
            <div class="px-3 py-4">
              ...
              <div class="mt-6">
                ...
                <ol class="pl-6 mt-1 list-decimal">
                  <li>
                    understand the use of illegal drugs is strictly prohibited including
                    marijuana
                  </li>
                  <li>
                    understand my booking permits only the number of guests stated on my
                    booking
                  </li>
                  <li>
                    agree to abide by all house rules and regulations set forth to ensure
                    the peace and enjoyment for all guests
                  </li>
                  <li>
                    agree to pay the access road toll fee owned and operated by the Museyo
                    Youth Community; N500 for a car or SUV or N1,000 for a vehicle above
                    six passengers, where cash is required.
                  </li>
                </ol>
              </div>
            </div>
